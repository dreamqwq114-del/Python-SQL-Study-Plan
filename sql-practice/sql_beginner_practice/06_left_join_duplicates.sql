...
-- 题 3：查询没有结束日期的项目并按预算降序；6 行。TODO:
...
-- INNER JOIN dbo.employees AS e ON e.department_id = d.department_id
-- INNER JOIN dbo.employee_projects AS ep ON ep.employee_id = e.employee_id
