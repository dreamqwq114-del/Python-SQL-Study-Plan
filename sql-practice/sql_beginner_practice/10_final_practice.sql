...
SELECT COUNT(*) AS project_count FROM dbo.projects;
SELECT COUNT(*) AS metric_count FROM dbo.project_metrics;
SELECT COUNT(*) AS employee_project_count FROM dbo.employee_projects;
