...
SELECT project_name FROM dbo.projects WHERE project_name LIKE N'%数据%';
...
-- SELECT employee_name FROM dbo.employees
-- WHERE hire_date >= '2024-01-01' AND salary < 8000 OR job_title = N'实习生';
-- 请加括号表达目标，并返回 employee_name、hire_date、salary、job_title。
-- TODO:

-- 题 10（改错）：下面 SQL 使用了 MySQL 写法。
-- 错误 SQL：SELECT employee_name FROM dbo.employees ORDER BY salary DESC LIMIT 3;
-- 改为 T-SQL，稳定返回工资最高的 3 人。TODO:
