...
练习的详细输入、输出、边界情况和提示都写在 [practice_01_series_and_dataframe.py](../../practice/pandas/practice_01_series_and_dataframe.py) 的 docstring 中。
...
```powershell
python -m examples.pandas.example_01_series_and_dataframe
pytest tests/pandas/test_pandas_practice.py -k "answer_01 or practice_01"
```
