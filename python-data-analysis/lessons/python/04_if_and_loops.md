...
打开 `practice/python/practice_04_if_and_loops.py`：
...
```powershell
python -m examples.python.example_04_if_and_loops
pytest tests/python/test_python_practice.py -k "answer_04 or practice_04"
```
