...
打开 `practice/python/practice_05_functions.py`：
...
```powershell
python -m examples.python.example_05_functions
pytest tests/python/test_python_practice.py -k "answer_05 or practice_05"
```
