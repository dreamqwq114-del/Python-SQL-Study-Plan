...
打开 `practice/python/practice_03_dictionaries.py`：
...
```powershell
python -m examples.python.example_03_dictionaries
pytest tests/python/test_python_practice.py -k "answer_03 or practice_03"
```
