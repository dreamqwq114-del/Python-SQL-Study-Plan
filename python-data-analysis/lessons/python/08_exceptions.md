...
打开 `practice/python/practice_08_exceptions.py`：
...
```powershell
python -m examples.python.example_08_exceptions
pytest tests/python/test_python_practice.py -k "answer_08 or practice_08"
```
