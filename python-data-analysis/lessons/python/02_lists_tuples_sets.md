...
打开 `practice/python/practice_02_lists_tuples_sets.py`：
...
```powershell
python -m examples.python.example_02_lists_tuples_sets
pytest tests/python/test_python_practice.py -k "answer_02 or practice_02"
```
