...
```text
utils/paths.py
examples/python/example_06_modules_and_imports.py
```
...
```powershell
python -m examples.python.example_06_modules_and_imports
```
...
打开 `practice/python/practice_06_modules_and_imports.py`：
...
```powershell
python -m examples.python.example_06_modules_and_imports
pytest tests/python/test_python_practice.py -k "answer_06 or practice_06"
```
