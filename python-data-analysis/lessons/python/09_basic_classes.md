...
打开 `practice/python/practice_09_basic_classes.py`：
...
```powershell
python -m examples.python.example_09_basic_classes
pytest tests/python/test_python_practice.py -k "answer_09 or practice_09"
```
