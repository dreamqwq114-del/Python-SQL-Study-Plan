...
每道题的标题、轴标签、DPI、边界情况和提示都写在 [practice_01_line_and_bar.py](../../practice/matplotlib/practice_01_line_and_bar.py) 中。

## 9. 运行命令

```powershell
python -m examples.matplotlib.example_01_line_and_bar
pytest tests/matplotlib/test_matplotlib_practice.py -k "answer_01 or practice_01"
```
