...
`answers/` 与 `practice/` 的函数接口一一对应，目前包含：
...
1. 阅读对应 lesson 并亲自运行短代码。
2. 运行 example，确认完整流程能工作。
3. 只编辑 practice 中的 TODO。
4. 根据 pytest 的失败信息修改。
5. 尝试过多种方法仍卡住时，再查看对应 answer。
6. 理解差异后关闭答案，在 practice 中从头独立写一遍。
